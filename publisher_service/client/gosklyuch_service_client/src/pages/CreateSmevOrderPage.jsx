...
import { fetchSmevOrderCreate } from "../repository/repository";
import { useNavigate } from "react-router";

export const CreateSmevOrderPage = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    fetchSmevOrderCreate(formData, files).then(() => navigate("/orders"))
    ...
    <>
      ...
      <main>
        <div className="container">
          ...
          <h2 className="mb-4">Создание запроса к СМЭВ</h2>
                ...
                <div className="row g-3 align-items-center mb-3">
                  ...
                  <div className="col-md-9">
                    <input
                      ...
                      placeholder="Введите СНИЛС получателя"
                      name="receiverId"
