...
import { fetchEsiaOrderCreate } from "../repository/repository";
import { useNavigate } from "react-router";

export const CreateEsiaOrderPage = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    fetchEsiaOrderCreate(formData, files).then(() => navigate("/orders"))
    ...
    <>
      ...
      <main>
        <div className="container">
          ...
          <h2 className="mb-4">Создание запроса к ЕСИА</h2>
